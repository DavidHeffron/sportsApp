...
export class ScoresComponent {
  ...
  getCurrentNflWeek(){
    ...
    var currentWeek;
    if(sessionStorage.getItem('selectedWeek')){
      this.currentNFLWeek = sessionStorage.getItem('selectedWeek')
      this.currentYear = sessionStorage.getItem('selectedYear')
      this.seasonType = sessionStorage.getItem('selectedSeasonType');
      this.displaySeasonIndex = sessionStorage.getItem('selectedSeasonIndex');
    }
    else{
      currentWeek = formatDate(today, 'w', 'en-US');
  ...
  changeWeek(backOrForward: string){
    ...
    this.getWeekMatchUps();
    sessionStorage.setItem('selectedWeek', this.currentNFLWeek);
    sessionStorage.setItem('selectedYear', this.currentYear!);
    sessionStorage.setItem('selectedSeasonType', this.seasonType!);
    sessionStorage.setItem('selectedSeasonIndex', this.displaySeasonIndex!);
